...
const htmlPath = 'c:/Users/rodri/Downloads/SITE RONCOLATO/index.html';
...
for (const [caseKey, folder] of Object.entries(folderMap)) {
  ...
  const coverPath = '/assets/IMG/' + folder + '/' + coverFile;

  // Build imgs array (all files)
  const imgsArr = files.map(f => '/assets/IMG/' + folder + '/' + f);
